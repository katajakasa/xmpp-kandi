...
\section{XMPP-Protokollan konsepteja}
...
Viestien l‰hetyst‰ varten asiakkaalla on oltava t‰ysi JID. Viestipakettina k‰ytet‰‰n "message"-elementti‰, jolla on oltava
aina v‰hint‰‰n "to"-parametri viestin vastaanottajan JID:t‰ varten. Elementiss‰ voidaan m‰‰ritell‰ myˆs "from"-parametri, johon
sijoitetaan viestin l‰hett‰j‰n JID.
...
\bibitem{xep0966}
Thomas Muldowney, Matther Miller, Ryan Eatmon, 
\textit{"XEP-0096: File Transfer"},
