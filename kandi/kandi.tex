...
pikaviestint‰, sek‰ ryhm‰ss‰ ett‰ kahdenkeskisesti.

\subsection{Muita protokollia}

T‰ss‰ tutkielmassa tarkasteltavan XMPP-protokollan lis‰ksi on olemassa myˆs muita pikaviestinprotokollia, kuten muunmuassa MSNP, Skype, IRC, SIMPLE 
...
yhdist‰‰ kokonaisuuksiksi eli keskusteluverkoiksi, joilla on nimi. Keskusteluverkossa voi olla useita keskustelukanavia, 
joille k‰ytt‰j‰ voi liitty‰ ~\cite{ircrfc}.
...
\begin{itemize}
  ...
  \item XEP-0166: Jingle. Laajennus videon, ‰‰nen ja muun datan siirtoa varten. \ldots
\end{itemize}
...
Virran alku ilmoitetaan aina XML-elementill‰ stream, jossa voidaan m‰‰ritell‰ attribuutteina myˆs esimerkiksi k‰ytett‰v‰ 
...
S‰keistˆjen nimiavaruuden on oltava "jabber:client" tai "jabber:server". Mik‰‰n muu tietovirrassa l‰hetetty paketti
ei ole s‰keistˆ. S‰keistˆ sis‰lt‰‰ yleens‰ yhden tai useampia lapsielementtej‰.

S‰keistˆll‰ on kolme tyyppi‰, joilla m‰‰ritet‰‰n viestint‰mekanismi. Push-mekanismi on tarkoitettu yleiseen viestint‰‰n,
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=0.9\textwidth]{siirtomenetelmat_cmp.png}
...
pahimmillaan olla moninkertainen itse paketissa l‰hetett‰v‰‰n tietoon. Kuvassa ~\ref{fig:viestipaketticmpkuva} kuvataan
standardin viestipaketin kokoa, kun viestin koko on kolme merkki‰ ja paketissa on protokollan kannalta vain kaikkein olennaisin
tieto. 
...
sis‰lt‰‰kin jo m‰‰ritelm‰ss‰‰n tuen yhteyden salaukseen TLS-protokollan yli. Taulukossa
~\ref{protocol_tls_support} luetellaan muutamien protokollien tilanne yhteyden salaukselle.
...
XMPP on nyky‰‰n jo eritt‰in kyps‰ standardi, ja soveltuukin hyvin eri pikaviestinn‰n osa-alueille.
Vaikka protokollaa ei nyky‰‰n viel‰ k‰ytet‰k‰‰n suurimmissa pikaviestinohjelmista, levi‰‰ se silti 
pienempien palveluiden kautta ja monien suurempien toimijoiden tuella eteenp‰in. Protokollan suurin
hyˆty onkin sen avoin dokumentaatio, hyvin suunniteltu m‰‰ritelm‰, yhteensopivuus olemassaolevien
j‰rjestelmien kanssa v‰lipalvelinj‰rjestelm‰‰ soveltamalla, sek‰ monet eri lisenssein saatavilla olevat
toteutukset protokollasta.

XMPP onkin hyv‰n rakenteensa ja avoimuutensa ansiosta saanut jo suuren joukon laajennuksia. Protokollan
ydinm‰‰ritelm‰st‰ taas on l‰hiaikoina tulossa uusi versio, johon on sis‰llytetty monia t‰rkeimmist‰ 
laajennuksista. XMPP onkin jatkuvan kehityksen ja parantuvan ohjelmatuen ansiosta valmis sopeutumaan myˆs 
tulevaisuuden pikaviestinn‰n luomiin vaatimuksiin ja haasteisiin.
