...
XMPP-protokollan ydinm‰‰ritelm‰ on hyvin yksinkertainen; siin‰ ei m‰‰ritell‰ esimerkiksi pikaviestint‰‰ tai
tilanhallintaa. Sen sijaan pikaviestint‰, tilanhallinta, puheviestint‰ sek‰ esimerkiksi videon ja tiedostojen v‰litys
ovat laajennuksia. Laajennukset m‰‰ritell‰‰n 
...
\begin{figure}[htp]
	\centering
	\includegraphics[scale=1.0]{kaverilista.png}
